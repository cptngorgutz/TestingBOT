...
//                           TB1 ULT 6 ROOM                             TB2 ULT 6 ROOM                              TB3 ULT 6 ROOM 
	...
	if (message.content.includes('Lane')) message.delete(10000);
	if (message.content.includes('╔')) message.delete();
	if (message.content.includes('1')) message.delete(58000);
	if (message.content.includes('2')) message.delete(40000);
	if (message.content.includes('3')) message.delete(25000);	
	if (message.content.includes('╚')) message.delete();
